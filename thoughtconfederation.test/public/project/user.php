...
<head>
    ...
    <!-- Favicons -->
    <link
        href="/project/assets/img/favicon.png"
        rel="icon">
    <link
        href="/project/assets/img/apple-touch-icon.png"
...
<body>
        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img id="avatarContainer" class="img-account-profile rounded-circle mb-2" src="https://www.gravatar.com/avatar/<?php echo md5($result['email']); ?>?s=200" alt="">
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form class="profile" id="profile" action="forms/update.php"
                            method="POST">
                            <!-- Form Row-->
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="first_name" class="form-control" type="text"
                                        placeholder="Enter your first name" value="<?php echo $result['first_name']; ?>">
                                </div>
                                <!-- Form Group (last name)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="last_name">Last name</label>
                                    <input name="last_name" class="form-control" type="text"
                                        placeholder="Enter your last name" value="<?php echo $result['last_name']; ?>">
                                </div>
                            </div>
                            <!-- Form Row -->
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="display_name" class="form-control" type="text"
                                        placeholder="Enter your Display Name" value="<?php echo $result['display_name']; ?>">
                                </div>
                                <!-- Form Group (location)-->
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <select hidden="true" id="region1" name="region1" class="form-select" value="<?php echo $result['region']; ?>">
                                            <option></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="form-group province">
                                        <select hidden="true" id="province1" name="province1" class="form-select" value="">
                                            <option></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col mb-3">
                                    <div class="form-group city">
                                        ...
                                        <select id="city" name="city" class="form-select" onchange="fetch_barangays()" value="<?php echo $result['city']; ?>">
                                            <option></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col mb-3">
                                    <div class="form-group barangay">
                                        ...
                                        <select id="barangay" name="barangay" class="form-select" value="<?php echo $result['barangay']; ?>">
                                            <option></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <select hidden="true" id="barangay1" name="barangay1" class="form-select" value="">
                                            <option></option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="phone_number" class="form-control" id="phone" type="tel" value="<?php echo $result['phone_number']; ?>">
                                </div>
                                <!-- Form Group (birthday)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="birthdate">Birthday</label>
                                    <input class="form-control" name="birthdate" id="birthdate" type="date"
                                        placeholder="Enter your birthday" value="<?php echo $result['birthdate']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col form-group">
                                    <textarea name="biography" class="form-control"
                                        placeholder="Say something..." maxlength="50"><?php echo $result['biography']; ?></textarea>
                                </div>
                        ...
                        <button type="submit" class="btn btn-primary" id="go"
                            onclick="location.href='security.php'">Password Edit</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script
        ...
        type="text/javascript"></script>
    <script
        src="assets/js/data.min.js"
        type="text/javascript"></script>
    <script
        src="assets/js/intlTelInput-jquery.js"
        type="text/javascript"></script>
    <script
    ...
    <script
        ...
        type="text/javascript"></script>
    <script
        src="assets/js/emailChecker.js"></script>
    ...
    <script>
        ...
        window.intlTelInput(input, {
            ...
            geoIpLookup: callback => {
                fetch("https://ipapi.co/json").then(res => res.json()).then(data => callback(data.country_code))
                    .catch(() => callback("us"));
            },
